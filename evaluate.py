...
def load_model_and_data(dataset_name, device):
    ...
    model_path = f'saved_models/multitagen_model_{dataset_name}.pth'
    ...
    elif dataset_name == 'davis' or dataset_name == 'bindingdb' or dataset_name == 'metz' or dataset_name == 'pdbbindv2020':
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Evaluate MultiDTAGen model and generated molecules.")
